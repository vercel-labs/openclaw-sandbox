...
export const getTtsPersona = stub.getTtsPersona;
...
export const listTtsPersonas = stub.listTtsPersonas;
...
export const setTtsPersona = stub.setTtsPersona;
